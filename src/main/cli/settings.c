...
// PG_PID_PROFILE
    ...
    { "setpoint_weight_scale",      VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 100 }, PG_PID_PROFILE, offsetof(pidProfile_t, setpointWeightScale) },
    { "setpoint_weight_max_error",  VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 100 }, PG_PID_PROFILE, offsetof(pidProfile_t, setpointWeightMaxError) },
